...
#-- top module name
set_option -top_module pwm_rgbled

#-- set result format/file last
project -result_file {D:/Project/Verilog/STEP/series_courses/02_PWM/impl_pwm/pwm_impl_pwm.edi}

#-- error message log file
project -log_file {pwm_impl_pwm.srf}
